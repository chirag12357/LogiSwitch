from . import modrequests as requests                                        #https://github.com/micropython/micropython-lib/tree/master/urequests
from .modrequests import Session                                                   #https://github.com/micropython/micropython-lib/tree/master/urequests
from .modrequests.exceptions import HTTPError                                      #https://github.com/micropython/micropython-lib/tree/master/urequests

try:
    from urllib.parse import urlencode, quote                                  #https://github.com/micropython/micropython-lib/tree/master/urequests
except:
    from urllib import urlencode, quote                                        #Not Required
import json                                                                    #Default Package : ujson
import math                                                                    #Default Package : math
from random import randrange                                                   #Default Package : random
import time                                                                    #Default Package : utime
from collections import OrderedDict                                            #Default Package : ucollections
from .pyre_sseclient import SSEClient                                          #Corrected
import threading                                                               #https://github.com/micropython/micropython-lib/tree/master/threading
import socket                                                                  #Default Package : usocket
from .modoauth2client.service_account import ServiceAccountCredentials         #Downloaded Package manually
from .modgcloud import storage                                                 #Downloaded Package manually
from requests.packages.urllib3.contrib.appengine import is_appengine_sandbox   #https://github.com/micropython/micropython-lib/tree/master/urequests
from requests_toolbelt.adapters import appengine                               #https://github.com/micropython/micropython-lib/tree/master/urequests

#import python_jwt as jwt
#from Crypto.PublicKey import RSA                                              
import datetime                                                                #https://github.com/micropython/micropython-lib/tree/master/datetime
